    ...
    <main>
      <div class="wrapper-main">
        <section class="section-default">
          <h1>Signup</h1>
          <?php
          //Eritellään mahdolliset virhetilanteet, joita rekisteröijä saattaisi tehdä.
          if (isset($_GET["error"])) {
            ...
            //Luodaan myös viesti jos kirjautuminen onnistui.
          ...
          <form class="form-signup" action="includes/signup.inc.php" method="post">
            <?php
            //Tarkastetaan lomake: käyttäjänimi
            if (!empty($_GET["uid"])) {
